...
file_ = open(f"{path}/Full_Logo_Vibrant_Turquoise.png", "rb")
...
def set_header():
    return st.markdown(f"""<div class='main-header'>
                    <!-- <h1>LiME </h1> -->
                       <div class='lime-logo'>
                       <p class = 'lime-text'>LiME</p>
                       <img class='lime-img' src="data:image;base64,{data_url1}", alt="Logo">
                       </div>
...
def initialize_data():
    ...
    excel = pd.read_excel("Overview_data.xlsx",sheet_name=None)
